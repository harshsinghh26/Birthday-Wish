  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xl text-purple-300">For My Guddaaa 💌</p>
      </motion.div>
              ...
              <div className="text-center">
                <p className="text-rose-700 font-semibold text-sm">
                  {revealedCards.length === 0
                    ...
                    ? `${
                        messages.length - revealedCards.length
                      } messages remaining`
          ...
          <AnimatePresence>
            {revealedCards.map((cardIndex, stackIndex) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-50 h-65 bg-gradient-to-br ${message.color} rounded-xl p-4 shadow-xl border border-white/20 relative overflow-hidden`}
                  >
                    <motion.div
